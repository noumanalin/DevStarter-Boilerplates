...
import { useUpdateBlog, useGetBlogBySlug, useGetAllCategoriesAdmin } from "../../api/blog/useBlog.js";
...
const EditBlog = () => {
    ...
    const { data: blogData, isLoading: blogLoading } = useGetBlogBySlug(slug);
    ...
    useEffect(() => {
        if (blogData) {
            ...
            setForm({
                ...
                featured_img_alt: blog.featured_img_alt || "",
                featured_img_caption: blog.featured_img_caption || "",
                ...
                searchableSnippets: blog.searchableSnippets || [],
                ...
                faqs: blog.faqs || [],
                schema_markup: blog.schema_markup ? JSON.stringify(blog.schema_markup, null, 2) : "",
            });
            setEditorContent(blog.content || "");
            if (blog.featured_img_url) {
                setImagePreview(blog.featured_img_url);
            }
        }
    }, [blogData]);
        ...
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                <div className="flex flex-col items-center gap-3">
                    <Loader2 size={40} className="animate-spin text-[var(--brand-primary)]" />
                    <p className="text-[var(--text-secondary)]">Loading blog data...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="mb-5">
                <div className="flex items-center justify-between flex-wrap gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-[var(--text-primary)]">Edit Post</h1>
                            <p className="text-sm text-[var(--text-secondary)] mt-0.5">Update your blog post</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        <button
